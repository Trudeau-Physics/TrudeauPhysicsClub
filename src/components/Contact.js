...
export function Contact() {
    return (
        <div id="contact" className='titlefont text-blueacc snap-center w-screen h-screen flex flex-col justify-around items-center bg-maincolor ' style={{ padding: '10vh' }}>
            <div className='titlefont text-orangeacc font-extrabold text-center text-3xl sm:text-5xl lg:text-8xl duration-700'>Contact</div>
