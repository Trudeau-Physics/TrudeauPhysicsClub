export function NavBar(props) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "text-slate-900 flex justify-around items-center mt-0 w-2/3 bg-clip-text bg-gradient-to-r"
  }, /*#__PURE__*/React.createElement("li", {
    onClick: () => handleClick("#home"),
    className: "flex items-center my-2 px-2 md:px-8 py-0 text-base sm:text-xl rounded hover:bg-opacity-80 hover:shadow-2xl hover:text-brightblueacc hover:bg-slate-400 duration-700 h-full"
  }, /*#__PURE__*/React.createElement("div", {
    className: "titlefont"
