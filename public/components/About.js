export function About() {
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    id: "about",
    className: "text-blueacc snap-center w-screen h-screen flex flex-col justify-center items-center bg-maincolor ",
    style: {
      padding: '10vh'
    }
  }, /*#__PURE__*/React.createElement("div", {
    className: "titlefont text-orangeacc text-3xl sm:text-5xl lg:text-8xl flex justify-center items-center w-full h-1/6 lg:h-1/3 duration-700 drop-shadow-lg shadow-white"
